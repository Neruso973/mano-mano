		...
		>
			{!openModal ? (
				<div className="bg-white  h-[80%] w-[80%] flex justify-around items-center rounded-3xl mt-24 p-2">
					<div className={`${color ? 'green_gradient' : 'pink_gradient'} container_scanner `}>
						<img src={photo} alt="suggestion" />
					</div>
					<div
						className={`${color
							? 'green_gradient'
							: 'pink_gradient'} container_scanner container_suggestion `}
					>
						<div className="text_suggestion grey_background">
							...
							<div className="container_text">
								<div className="flex items-center m-4">
									<div className={`${color ? 'green_gradient' : 'pink_gradient'} checkbox  `}>
										{color ? <img src={etagere} /> : <img src={trace} />}
									</div>
									{color ? (
										<Link to="/starterbrico" className="green_gradient text-white rounded-2xl p-4">
								...
								<div className="flex  items-center m-4">
									...
									{color ? (
										<p className="green_gradient">Mettre une goutière cache fils ?</p>
									) : (
							...
							<div className="text-center m-12 cursor-pointer">
								<p className={`${color ? 'blue_text' : 'green_text'}  `}>D’autres envies ?</p>
								{color ? (
									<h2

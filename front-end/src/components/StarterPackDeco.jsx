			...
			<div className="mt-16 flex flex-col justify-center">
				<div className="flex justify-between bg-white">
					<div className="flex flex-col w-[40%]">
						<h2 className="pink_gradient rounded-xl text-xl my-6  mx-10 p-2 text-white text-center">
							{' '}
							Peindre un mur ?
						</h2>
						<iframe
					...
					<div className="relative flex flex-col w-[50%]">
						<h2 className="text-[#FFABC9] text-2xl">Votre pack comprend: </h2>
						...
						<button className="pink_gradient text-white font-bold rounded-2xl w-1/3 p-2 mt-8 hover:scale-110 transition-all absolute w-5/12 h-12 bottom-20 right-14">
							Ajouter au panier
						</button>
					</div>
				</div>

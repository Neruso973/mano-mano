      ...
      <div className="mt-16 flex flex-col justify-center">
        <div className="flex justify-between bg-white">
          <div className="flex flex-col items-center w-[50%]">
            <h2 className="bg-gradient-to-r from-[#24A6B2] to-[#00ECCD] w-96 rounded-xl text-xl my-6  mx-10 p-2 text-white text-center">
              {" "}
          ...
          <div className="relative flex flex-col w-[50%]">
            <h2 className="green_text text-2xl font-bold">
              Votre pack comprend:{" "}
            </h2>
            <div className="bg-[#F5F6F7] mb-4 rounded-tl-xl">
            ...
            <button
              ...
              className="bg-gradient-to-r from-[#24A6B2] to-[#00ECCD] text-white font-bold rounded-2xl w-52 p-2 mt-8 hover:scale-110 transition-all absolute h-12 bottom-16 right-64"
            >
              Ajouter au panier
            </button>
          </div>

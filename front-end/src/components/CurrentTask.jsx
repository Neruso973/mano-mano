...
function CurrentTask() {
  ...
  return (
    <div className="bg-white  h-[80%] w-[80%] flex flex-col justify-around items-center rounded-3xl mt-24 p-2 fixed top-10">
      <div className="blue_text text-lg text-left mx-0 font-bold w-[80%]">
        <p className="my-2">
          ...
          ses traveaux d’intérieur, ManoMano vous propose ses{" "}
          <span className="green_text">ManoTuto :</span>
        </p>
      ...
      <div className="flex justify-between w-[80%] text-white">
        <div className="flex flex-col">
          <button className="bg-gradient-to-r from-[#24A6B2] to-[#00ECCD] rounded-xl text-xl mt-6 p-2">
            Mettre une étagére a niveau ?{" "}
          </button>
          <button className="bg-gradient-to-r from-[#24A6B2] to-[#00ECCD] rounded-xl text-xl mt-6 p-2">
            Retouches peintures ?{" "}
          </button>
      ...
      <input
        type="text"
        placeholder="Autre"
        className="rounded-3xl border-solid border-2 my-8 p-2 w-[20%]"
      />
    </div>
  );
}
